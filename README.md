...
|---------------------|---------------------|
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. | Josef Cesar Romero Florida<br>TB1: Realizó el EventStorming, Candidate Context Discovery y Domain Message Flows Modeling.<br>TB2: Desarrolló el backend de la aplicación.<br><br>Richar Varoni Romero Cacha<br>TB1: Desarrolló el Design Purpose y Attribute-Driven Design Inputs.<br>TB2: Implementó el frontend de la aplicación.<br><br>Ángel Gustavo Chuco Michel<br>TB1: Elaboró Quality Attribute Scenario Refinements, Bounded Context Canvases y Context Mapping.<br>TB2: Aplicó el feedback recibido al informe, mejorando su calidad y claridad.<br><br>Frank Yamil Alva Cordova<br>TB1: Preparó el Architectural Drivers Backlog y Architectural Design Decisions.<br>TB2: Contribuyó al desarrollo del backend de la aplicación.<br><br>Lino Abraham Quenta Leon<br>TB1: Creó el Software Architecture System Landscape Diagram, Software Architecture Context Level Diagrams, Software Architecture Container Level Diagrams y Software Architecture Deployment Diagrams.<br>TB2: Desarrolló la aplicación móvil. |
| Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. | Josef Cesar Romero Florida<br>TB1: Documentó el proceso de EventStorming, Candidate Context Discovery y Domain Message Flows Modeling.<br>TB2: Elaboró la documentación técnica del backend.<br><br>Richar Varoni Romero Cacha<br>TB1: Redactó las secciones de Design Purpose y Attribute-Driven Design Inputs.<br>TB2: Documentó la implementación del frontend y sus componentes.<br><br>Ángel Gustavo Chuco Michel<br>TB1: Documentó los Quality Attribute Scenario Refinements, Bounded Context Canvases y Context Mapping.<br>TB2: Revisó y mejoró la redacción general del informe basándose en el feedback recibido.<br><br>Frank Yamil Alva Cordova<br>TB1: Elaboró el informe del Architectural Drivers Backlog y Architectural Design Decisions.<br>TB2: Contribuyó a la documentación del backend y sus APIs.<br><br>Lino Abraham Quenta Leon<br>TB1: Preparó la documentación de los diagramas de arquitectura de software.<br>TB2: Redactó la documentación de la aplicación móvil, incluyendo su arquitectura y funcionalidades. |
